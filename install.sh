...
STEAMOS_BTRFS_HOME_MOUNT_OPTS_DEFAULT='defaults,nofail,x-systemd.growfs,noatime,lazytime,compress-force=zstd:12,space_cache=v2,autodefrag,nodiscard'
...
PKGS=(f2fs-tools reiserfsprogs kdialog wmctrl patch exfatprogs compsize rmlint duperemove rsync)
PKGS_SIZE="${#PKGS[@]}"
